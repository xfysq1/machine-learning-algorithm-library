...
from .io_GA import GeneticAlgorithmBase, io_GA
...
class io_DE(GeneticAlgorithmBase):
    ...
    def construct_DE_model(self, max_iter=None):
        ...
        result_DE = [global_best_Y,global_best_X]
